      ...
      <div className="w-full max-w-3xl flex flex-col gap-4">
        {FAQs.map((faq, index) => (
          ...
          >
            ...
            >
              <div className="text-left text-sm sm:text-base md:text-lg pl-4 sm:pl-6 font-semibold font-montserrat">
                {faq.question}
              </div>
              <Image
                src={
            ...
            >
              ...
              <div className="px-4 sm:px-6 pb-5 pt-3 text-white/75 text-sm sm:text-base font-poppins">
                {faq.answer}
              </div>
            </div>
          </div>
