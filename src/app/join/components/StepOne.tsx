      ...
      <div className="w-full flex flex-wrap items-center justify-center gap-6 sm:gap-8">
        {options.map((option) => (
          <button
            ...
            className={`w-[90%] xs:w-64 sm:w-60 md:w-64 h-64 sm:h-72 relative bg-slate-900/75 rounded-xl shadow-lg border transition-all duration-300 group overflow-hidden ${
